...
class KendaraanTest {
    ...
    void testRamahLingkungan(String jenis,
                             String bahanBakar,
                             int jumlahRoda,
                             boolean expected) {
    ...
    static Stream<Arguments> provideKendaraanData() {
        return Stream.of(
                Arguments.of(new Kendaraan("Mobil",
                        "Bensin", 4), 4),
                Arguments.of(new Kendaraan("Motor",
                        "Listrik", 2), 2),
                Arguments.of(new Kendaraan("Truk",
                        "Solar", 6), 6)
        );
    }
    ...
    void testIsSepeda(String jenis,
                      String bahanBakar,
                      int jumlahRoda,
                      boolean expected) {
        Kendaraan kendaraan = new Kendaraan(jenis,
    ...
    void testIsBermotor(String jenis,
                        String bahanBakar,
                        int jumlahRoda,
                        boolean expected) {
        Kendaraan kendaraan = new Kendaraan(jenis,
    ...
    void testIsTransportasiUmum(String jenis,
                                String bahanBakar,
                                int jumlahRoda,
                                boolean expected) {
        Kendaraan kendaraan = new Kendaraan(jenis,
